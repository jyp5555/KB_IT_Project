        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                     ...
                     <li class="nav-item nav-link"><a href="/board" class="custom">Community</a></li>
					...
					<li class="nav-item nav-link"><sec:authorize access="isAuthenticated()"><a href="/logout" class="custom">로그아웃</a></sec:authorize></li>
