				...
				<form id="frm">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-3">
							...
							<input type="number" class="form-control" id="companyTopprice" name="companyTopprice">
						</div>
						<div class="form-group col-md-3">
							<label for="companyBottomprice" class="col-form-label">희망 공모가액 하단 *</label> 
							<input type="number" class="form-control" id="companyBottomprice" name="companyBottomprice">
						</div>
						<div class="form-group col-md-3">
