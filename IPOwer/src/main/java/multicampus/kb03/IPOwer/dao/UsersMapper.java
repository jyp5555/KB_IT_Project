...
public interface UsersMapper {
	...
	@Insert("INSERT INTO USERS(USER_PK, USER_ID, USER_PW, USER_NAME, USER_PHONE, USER_REGDATE, ROLE_PK) VALUES(1,#{user.userId},#{user.userPw},#{user.userName},#{user.userPhone},SYSDATE,1)")
